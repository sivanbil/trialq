...
use regitry_code::{ generate_random_string, verify_password, encrypt_password};
...
impl UserService {
    ...
    pub fn upsert_or_save_user(&self, email: String, license_key: String, expire_date: String) -> Result<(), String> {
